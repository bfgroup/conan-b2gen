    ...
    def b2_variation(self):
        ...
        if not self._b2_variation:
            ...
            self._b2_variation['toolset'] = {
                ...
                'clang': 'clang',
                'apple-clang': 'clang'
            }.get(self.settings.get_safe('compiler'))+'-'+self.b2_toolset_version
            ...
            self._b2_variation['target-os'] = {
                ...
                'SunOS': 'solaris',
                'Arduino': 'linux',
            }.get(self.settings.get_safe('os'))
            self._b2_variation['variant'] = {
                'Debug': 'debug',
                'Release': 'release',
                'RelWithDebInfo': 'relwithdebinfo',
                'MinSizeRel': 'minsizerel',
            }.get(self.settings.get_safe('build_type'))
            self._b2_variation['cxxstd'] = {
                ...
                '2b': '2b', 'gnu2b': '2b',
                '2c': '2c', 'gnu2c': '2c',
            }.get(self.settings.get_safe('cppstd'))
